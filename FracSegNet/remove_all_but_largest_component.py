...
if __name__ == "__main__":
    input_folder = "/mnt/Enterprise2/shirshak/PENGWIN_TASK/PENGWIN_CT/nifti_fragments_LI_SA_RI/labels"
    output_folder = "/mnt/Enterprise2/shirshak/PENGWIN_TASK/PENGWIN_CT/preprocessed_nifti_fragments_LI_SA_RI/labels"
    apply_postprocessing_to_folder(input_folder, output_folder, for_which_classes = None)
