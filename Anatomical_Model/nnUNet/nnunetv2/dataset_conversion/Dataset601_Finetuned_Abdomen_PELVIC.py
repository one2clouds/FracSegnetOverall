...
train_ct_names = sorted(glob.glob("/mnt/Enterprise2/shirshak/PENGWIN_TASK/PENGWIN_CT/part*/*.mha"))
train_mask_names = sorted(glob.glob("/mnt/Enterprise2/shirshak/PENGWIN_TASK/PENGWIN_CT/labels/*.mha"))
...
# nnUNetv2_plan_and_preprocess -d 601
# nnUNetv2_extract_fingerprint -d 600 

# copy this file ---------> /mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/dataset/nnUNet_preprocessed/Dataset601_CT_PelvicFrac150/nnUNetPlans.json 
# into this folder ----->  /mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/Target_plans_identifier_for_finetuning

# nnUNetv2_move_plans_between_datasets -s 600 -t 601 -sp /mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/dataset/nnUNet_preprocessed/Dataset600_CT_PelvicAnatomical/nnUNetPlans -tp /mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/Target_plans_identifier_for_finetuning/nnUNetPlans
# nnUNetv2_preprocess -d 600 -plans_name /mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/Target_plans_identifier_for_finetuning/nnUNetPlans

# TODO
# nnUNetv2_train 600 3d_fullres 4 -p /mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/Target_plans_identifier_for_finetuning/nnUNetPlans
# nnUNetv2_train 601 3d_fullres 4 -pretrained_weights /mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/dataset/nnUNet_results/Dataset601_CT_PelvicFrac150/nnUNetTrainer__/mnt/Enterprise2/shirshak/NewFracSegNet/Anatomical_Model/Target_plans_identifier_for_finetuning/nnUNetPlans__3d_fullres/fold_4/checkpoint_best.pth
